...
- `demo-c-light.html` をダブルクリック
- または、ブラウザにドラッグ&ドロップ

**方法2: ローカルサーバー経由**
```bash
cd /Users/sk/Desktop/gooutweb
python3 -m http.server 9000
```
- http://localhost:9000/demo-c-light.html
- http://localhost:9000/demo-c-gray.html
- http://localhost:9000/demo-c-dark.html
...
- 記事例: https://web.goout.jp/fes_music/460914/
